...
public class FundraisingBoxControlScript : MonoBehaviour {
	...
	void Update () 
	{
		...
		if (currentFundraising == "CrazyHair")
		{
			...
			timeText.text = "It will take " + StaticValuesScript.crazyHairDayTime.ToString() + " Hours";
		}
		...
		if (currentFundraising == "SponsoredSilence")
		{
			...
			timeText.text = "It will take " + StaticValuesScript.sponsoredSilenceTime.ToString() + " Hours";
		}
		...
		if (currentFundraising == "SponsoredRun")
		{
			...
			timeText.text = "It will take " + StaticValuesScript.sponsoredRunTime.ToString() + " Hours";
		}
